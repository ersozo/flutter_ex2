              ...
              Row(
                ...
                children: [
                  IconluButonum(
                    ...
                    yazi: 'Beğen',
                    fonksiyonum: () => print('beğenildi'),
                  ),
                  IconluButonum(
                    ikonum: Icons.comment,
                    yazi: 'Yorum Yap',
                    fonksiyonum: () => print('yorum yapıldı'),
                  ),
                  // IconluButonum(ikonum: Icons.share, yazi: 'Paylaş',fonksiyonum: () => print('paylaşıldı'),),
                  FlatButton.icon(
                    onPressed: () => print('paylaşıldı'),
                    icon: Icon(
                      Icons.share,
                      color: Colors.grey,
                    ),
